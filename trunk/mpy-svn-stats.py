...
def output_stats(config, stats):
    ...
    for statistic in stats:
        ...
        if isinstance(statistic, TableStatistic):
            ...
            f.write('<p style="text-align: center"><img src="%s"/></p>' % g.get_image_fname())


    f.write("<hr/><p class='foot'>Generated by <a href='http://mpy-svn-stats.berlios.de/'>mpy-svn-stats</a> at %s</p>" % str(datetime.datetime.now().ctime()))
    f.write("</body></html>");
